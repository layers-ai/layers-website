            ...
            <div className="mt-6 space-y-6 text-lg leading-8 text-gray-800">
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  regarding the processing of your sensitive health data.
                  Information about how to exercise your{" "}
                  <strong>right of revocation under German law</strong> (to the
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  advice. This will enable users to gain insights into their
                  lives and enact change. layers may summarize specific aspects
                  of your entries into regular reports. Moreover, layers may
                  provide a personal profile that summarizes your personality
                  traits. Additionally, layers may provide content and advice
                  (e.g. videos or text) that helps you lead a happy and
                  fulfilling life. You can find general information about the
                  layers app on the layers website (details regarding the scope
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  contractually agreed Paid Services or the duration and
                  termination of the contract. However, this does not prevent us
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  a substitute for a diagnosis or medical or psychotherapeutic
                  treatment. Specific medical conditions can only be diagnosed
                  and treated properly by a qualified healthcare professional.
                  If you feel that the use of the layers services causes you any
                  physical or mental distress, please stop using them and seek
                  medical help. We cannot give you medical advice, but if you
                  have any complaints, comments, or feedback on the layers
                  services, you can reach out to us by writing an email to
                  <span class="email">
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  users to opportunity to gain insights into their lives and
                  enact change. layers may summarize specific aspects of your
                  entries into regular reports. Moreover, layers may provide a
                  personal profile to you, that shows your personality traits.
                  Additionally, layers may provide content and advice (e.g.
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  you will see in the order options.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  , including all documents, declarations, and consents included
                  therein by reference. Furthermore, you will need to provide an
                  email address and a personalized password. In addition, you
                  can provide other information as part of your onboarding, in
                  order to personalize your layers experience from the start.
                  Account creation is completed when you click on the link in
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  We may accept your registration or order by activating the
                  relevant service, i.e. without making a specific written
                  declaration.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  aren&apos;t working out as planned. The applicable price offer
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  or per year). Our subscription will automatically be renewed
                  for an indefinite time at the end of your initial subscription
                  period, unless we or you have canceled your subscription or
                  disabled auto-renewal or you have concluded a new contract
                  with a new initial subscription period with us. In case of an
                  indefinite subscription period after the end of your
                  applicable initial subscription period, you may cancel your
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  at its sole discretion, if you may participate in a Trial. In
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  your access will be converted into a paid Subscription Access
                  on the day following the end of the Trial. In this situation,
                  your subscription renews itself on a recurring basis and can
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  Trial (for example, by simply going to your layers Account
                  Settings or the respective app store settings).
                </p>
              </div>
              <div>
                <h2 className="text-xl font-semibold mt-4">
                ...
                <ul className="list-disc pl-6 mt-2 font-light text-base">
                  ...
                  <li>
                    bypass the access control systems of paid services or to
                    take other measures in order to use services without
                    authorization;
                  </li>
                  <li>
                    remove or obscure copyright notices and/or notices regarding
                    trademarks or other intellectual property rights of layers,
                    companies affiliated with layers or third parties;
                  </li>
                  <li>
                    transfer or assign rights or obligations under these Terms
                    to third parties.
                  </li>
                </ul>
                <p className="mt-4 font-light text-base">
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  activations may be required to make full use of the service.
                  From time to time, the layers app may automatically download
                  and install updates and upgrades without specifically
                  informing you. These updates are intended to technically
                  improve and/or enhance the software and service. You agree
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  arises only if and insofar as the counterclaim is based on the
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  processing, distribution and any form of commercial
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  not entitled to decompile, change or edit the App beyond the
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  , which you also consent to when you create a layers account
                  and use the layers app. In addition, you agree that{" "}
                  <strong>
                    by creating an account and using layers, you grant us
                    permission to use your anonymous information to improve the
                    layers services for all users.
                  </strong>
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  currency of the content. We are also in no way responsible or
                  liable for the entries you create or otherwise provide in the
                  layers app (&quot;user content&quot;). You are solely
                  responsible for the security of your personal user content.
                  Except to the extent required by law, we accept no liability
                  for the deletion, damage or failure to store user content
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  physician, psychotherapist or other health care provider can
                  do that. Please consult with a licensed physician,
                  psychotherapist or other qualified healthcare provider before
                  making any decisions or taking any actions that may affect
                  your health. Should you have depression, have been diagnosed
                  with another mental disorder or have other existing mental
                  health conditions, always speak to a licensed physician,
                  psychotherapist or other qualified healthcare provider before
                  starting layers practices to talk through your options and to
                  consult using layers app in your particular case. If you have
                  serious mental health conditions or are at risk of harming
                ...
                <ul className="list-disc pl-6 mt-2 font-light text-base">
                  ...
                  <li>
                    (b) from injury to life, body or health resulting from a
                    breach of duty by us or one of our legal representatives or
                    vicarious agents,
                  </li>
                  <li>
                    (c) in cases of liability under the German Product Liability
                    Act, due to us having given a guarantee or due to fraudulent
                    misrepresentation, and
                  </li>
                  <li>
                    (d) which has arisen due to the breach of a fundamental
                    obligation, the fulfilment of which is of fundamental
                    importance to the proper execution of the contract, and
                    which you are entitled to rely on and in fact regularly rely
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  before the end of the agreed term or you conclude a new
                  contract (with a new initial term) with us. In case of an
                  indefinite term after the end of your applicable initial term,
                  you may cancel your Paid Services with a notice period of at
                  least 24 hours to the end of each subscription month. If you
                  cancel your subscription, remember that you will still have
                  access to all Paid Services features and modes until your
                  subscription runs out. For example, if you cancel a yearly
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  terminated via the respective app stores or in the app (e.g.
                  using a feature provided by the respective app store). In such
                  cases, the respective app store provider may act as a reseller
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  example, deemed to exist if the continuation of the
                  contractual relationship until the end of the normal period of
                  notice is unreasonable, given all circumstances of the
                  individual case and the interests of the user. Good causes for
                  us to exercise this right of termination include, in
                  particular, if you breach applicable law, obligations under
                  these Terms, or obligations under your contract with the Apple
                  App Store (or if your actions would cause us to breach our
                  contracts with the Apple App Store).
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  services and functionalities that are provided within the app
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  inform you in writing about the transfer; you are then
                  entitled to terminate the contract. The notice of termination
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  at any time. We are neither obliged nor willing to participate
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  provision whose effects come as close as possible to the
                  economic objective which the contracting parties had pursued
                  with the invalid or unenforceable provision. The above
                  provisions shall also apply in the event that the provisions
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  at users who are consumers within the meaning of § 13 BGB
                  (German Civil Code), German law gives you a right to cancel
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  your purchase.{" "}
                  <strong>
                    The below reflects standard language prescribed by German
                    law.
                  </strong>
                </p>
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  revocation, you must inform us (layers labs UG, Maybachufer
                  11, 12047 Berlin, or contact Support by email
                  <span class="email">
                    hello@layers<b>layers</b>journal<b>journal</b>.app
                  </span>
                  ) of your decision to revoke this contract. You may use the
                  attached sample revocation form for this purpose, but this is
                  not mandatory. In order to comply with the revocation period,
                  it is sufficient that you send us notification regarding your
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  select a different type of delivery than the cheapest standard
                  delivery offered by us), immediately and no later than
                  fourteen days from the date on which we receive notice of your
                  revocation of this contract. For this refund, we will use the
                ...
                <p className="mt-4 font-light text-base">
                  ...
                  the cancellation period, you shall pay us a reasonable amount
                  corresponding to the proportion of the services already
                  provided by the time you inform us of the exercise of the
              ...
              <div>
                ...
                <p className="mt-4 font-light text-base">
                  - To: layers labs UG (haftungsbeschränkt), Maybachufer 11,
                  12047 Berlin.{" "}
                  <span class="email">
                    hello@layers<b>layers</b>journal<b>journal</b>.app
                  </span>
