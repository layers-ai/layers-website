            ...
            <div className="mt-6 space-y-6 text-xl leading-8 text-gray-800">
              ...
              <div>
                ...
                <p className="mt-4 ml-4">
                  <em>
                    I agree to my usage and device data being processed so
                    layers can optimize their advertising efforts to more
                    effectively tell more people about layers. Certain
                    third-party providers, including some located outside of the
                    European Union, are used to help with this.
                  </em>
                </p>
                <p className="mt-4 font-light">
              ...
              <div>
                ...
                <p className="mt-4 font-light">
                  ...
                  legal requirements. layers is made by layers UG, XXXX, Berlin.
